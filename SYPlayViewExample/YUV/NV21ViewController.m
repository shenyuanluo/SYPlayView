...
@implementation NV21ViewController
...
- (void)dealloc
{
    NSLog(@"-------- NV21ViewController dealloc --------");
}
...
- (void)readYUVData
{
    ...
    {
        filePath = [[NSBundle mainBundle] pathForResource:@"XinWenLianBo_480x360_NV21"
                                                   ofType:@"yuv"];
    }
    else    // 真机
    {
        ...
        filePath = [NSString stringWithFormat:@"%@/%@", docPath, @"XinWenLianBo_480x360_NV21.yuv"];
    }
